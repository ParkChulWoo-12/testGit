package com.ensalad.product.model.vo;
...
public class Product {
   ...
   public Product() {
	...
	public Product(int productNo, int productPrice, String productName, String productType, String productContent,
			int eventCode, String productThumbnail, String productImg1, String productImg2, String productImg3,
	...
	public String toString() {
		return "Product [toString()=" + super.toString() + ", productNo=" + productNo + ", productPrice=" + productPrice
				+ ", productName=" + productName + ", productType=" + productType + ", productContent=" + productContent
				+ ", eventCode=" + eventCode + ", productThumbnail=" + productThumbnail + ", productImg1=" + productImg1
